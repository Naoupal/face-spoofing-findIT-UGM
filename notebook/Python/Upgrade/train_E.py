...
def train_model():
    ...
    # Model Inisialisasi
    model = timm.create_model('efficientnet_b3', pretrained=True, num_classes=len(class_names), drop_rate=0.3).to(DEVICE)
    ...
    print(f"🚀 Memulai Training EfficientNet-B3 di {DEVICE}")
